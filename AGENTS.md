...
- `query_business_data` accepts one certified analysis ID and maps it inside the host to fixed metrics, dimensions, periods, and filters. It must never accept model-generated SQL, table names, column names, or free-form expressions.
